...
var Tracing = /*#__PURE__*/function () {
  ...
  _createClass(Tracing, [{
    ...
    value: function connect(wsUrl) {
      ...
      this.wsURL = wsUrl;
      this.ws = new _reconnectingWebsocket["default"](this.wsURL, "emscripten-trace", {
        maxRetries: Infinity,
    ...
    value: function _onMessage(data) {
      ...
      try {
        ...
        if (ids.length) this.queue = this.queue.filter(function (msg) {
    ...
    key: "_scheduleSend",
    value: function _scheduleSend(timeout) {
